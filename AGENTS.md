...
**Not implemented:** remaining venue adapters (WHI-805), collector, Others section
page (WHI-811), fees/simulate UI. Do not assume a module exists until its issue lands.
