...
(WHI-799), venue API survey (WHI-800) — all under
`docs/research/`. Solana prop AMM quote redundancy / Jupiter SPOF research:
WHI-837 + ADR 0001 (`docs/research/`, `docs/adr/`). M2 backend scaffold
