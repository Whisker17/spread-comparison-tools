...
| Tessera | Base | KyberSwap `includedSources` | `tessera` | pools `0xf524…5a7c` (WETH/USDC), `0xed57…c356` (cbBTC/USDC), `0x3b84…069e` (AERO/USDC) |
| Tessera | BSC | KyberSwap `includedSources` | `tessera` | pool `0xe119…7210` (BTCB/USDT) |
